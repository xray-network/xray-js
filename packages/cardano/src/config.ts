...
export const DEFAULT_ACCOUNT_DERIVATION_PATH: CardanoTypes.AccountDerivationPath = [
  DERIVATION_SCHEME.purpose.hdwallet,
  DERIVATION_SCHEME.coinType.ada,
  DERIVATION_SCHEME.account.first,
]

export const DEFAULT_ADDRESS_DERIVATION_PATH: CardanoTypes.AddressDerivationPath = [
  DERIVATION_SCHEME.role.payment,
  DERIVATION_SCHEME.index.first,
]

export const DEFAULT_PROTOCOL_PARAMETERS: CardanoTypes.ProtocolParameters = {

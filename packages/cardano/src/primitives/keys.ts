...
const deriveBip32PrivateKey = (
  xprvKey: string,
  accountPath?: CardanoTypes.AccountDerivationPath,
  addressPath?: CardanoTypes.AddressDerivationPath
...
export const xprvKeyToXpubKey = (
  ...
  return deriveBip32PrivateKey(xprvKey, accountPath, addressPath).to_public().to_bech32()
}
...
export const derivePrivateKey = (
  ...
  return deriveBip32PrivateKey(xprvKey, accountPath, addressPath).to_raw_key().to_bech32()
}
